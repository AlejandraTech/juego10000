...
import com.bigotitech.rokub10000.presentation.common.components.loading.LoadingIndicator
...
/**
 * Pantalla de splash con animaciones de entrada.
 * Muestra el logo de la aplicación mientras se cargan los recursos iniciales.
 *
 * @param onSplashFinished Callback que se ejecuta cuando termina el splash
 * @param viewModel ViewModel que gestiona la inicialización
 */
@Composable
fun SplashScreen(
